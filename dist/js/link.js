...
var LinkRoom = function (ctr,data) {
    ...
    // }
    //连接link
    var account=sessionStorage.getItem("aPhone");
    var token=sessionStorage.getItem("aImtoken");
    var roomid=sessionStorage.getItem("roomid")
    var chartrooom=sessionStorage.getItem("chartrooom");
    var addr=sessionStorage.getItem("addr");
    var address=[];
    address.push(addr);
    console.log(chartrooom);
    var info={
            token:token,
            account:account,
    ...
    var doLink = function(data){
        that.room = new SDK.Chatroom({
            ...
            token: data.token,
            chatroomId: data.chartroomId,
            chatroomAddresses:data.chatroomAddresses,
