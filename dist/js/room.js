...
$.ajax({
	...
	success: function(res){
		console.log(res);
		if (res.code==100000) {
			roomId=res.data.channel.aRoomid;
		}else{
...
var page = {
	init:function () {
		var options= {
	        ...
	        account: account,
	        id: roomId,//roomId
	        token: token,//aImtoken
	        // chatroomNick:util.readCookie("aNickname"),
	        // chatroomAvatar:"https://api.netease.im/nimserver/user/create.action"
    	}
